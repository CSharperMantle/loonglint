...
#ifndef LOONGLINT_RULES_RISCV_NOPZBKBRULE_HPP
#define LOONGLINT_RULES_RISCV_NOPZBKBRULE_HPP
...
class NopZbkbRule final : public Rule {
  public:
    explicit NopZbkbRule(const RISCVSpec &RISCVAS);
