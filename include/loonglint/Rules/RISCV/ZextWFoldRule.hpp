...
#ifndef LOONGLINT_RULES_RISCV_ZEXTWFOLDRULE_HPP
#define LOONGLINT_RULES_RISCV_ZEXTWFOLDRULE_HPP
...
class ZextWFoldRule final : public Rule {
  public:
    explicit ZextWFoldRule(const RISCVSpec &RISCVAS);
