...
#ifndef LOONGLINT_RULES_RISCV_ZBSNOPRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBSNOPRULE_HPP
...
class ZbsNopRule final : public Rule {
  public:
    explicit ZbsNopRule(const RISCVSpec &RISCVAS);
