...
#ifndef LOONGLINT_RULES_RISCV_BITREPEATRULE_HPP
#define LOONGLINT_RULES_RISCV_BITREPEATRULE_HPP
...
class BitRepeatRule final : public Rule {
  public:
    explicit BitRepeatRule(const RISCVSpec &RISCVAS);
