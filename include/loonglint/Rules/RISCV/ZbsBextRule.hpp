...
#ifndef LOONGLINT_RULES_RISCV_ZBSBEXTRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBSBEXTRULE_HPP
...
class ZbsBextRule final : public Rule {
  public:
    explicit ZbsBextRule(const RISCVSpec &RISCVAS);
