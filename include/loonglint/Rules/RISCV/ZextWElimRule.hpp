...
#ifndef LOONGLINT_RULES_RISCV_ZEXTWELIMRULE_HPP
#define LOONGLINT_RULES_RISCV_ZEXTWELIMRULE_HPP
...
class ZextWElimRule final : public Rule {
  public:
    explicit ZextWElimRule(const RISCVSpec &RISCVAS);
