...
#ifndef LOONGLINT_RULES_RISCV_ZBAZEXTWRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBAZEXTWRULE_HPP
...
class ZbaZextWRule final : public Rule {
  public:
    explicit ZbaZextWRule(const RISCVSpec &RISCVAS);
