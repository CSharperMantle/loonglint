...
#ifndef LOONGLINT_RULES_RISCV_ZBASHADDRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBASHADDRULE_HPP
...
class ZbaShAddRule final : public Rule {
  public:
    explicit ZbaShAddRule(const RISCVSpec &RISCVAS);
