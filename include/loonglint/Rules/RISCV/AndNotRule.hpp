...
#ifndef LOONGLINT_RULES_RISCV_ANDNOTRULE_HPP
#define LOONGLINT_RULES_RISCV_ANDNOTRULE_HPP
...
class AndNotRule final : public Rule {
  public:
    explicit AndNotRule(const RISCVSpec &RISCVAS);
