...
#ifndef LOONGLINT_RULES_RISCV_ZBBROTATERULE_HPP
#define LOONGLINT_RULES_RISCV_ZBBROTATERULE_HPP
...
class ZbbRotateRule final : public Rule {
  public:
    explicit ZbbRotateRule(const RISCVSpec &RISCVAS);
