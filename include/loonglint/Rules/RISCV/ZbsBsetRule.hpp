...
#ifndef LOONGLINT_RULES_RISCV_ZBSBSETRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBSBSETRULE_HPP
...
class ZbsBsetRule final : public Rule {
  public:
    explicit ZbsBsetRule(const RISCVSpec &RISCVAS);
