...
#ifndef LOONGLINT_RULES_RISCV_ZBANOPRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBANOPRULE_HPP
...
class ZbaNopRule final : public Rule {
  public:
    explicit ZbaNopRule(const RISCVSpec &RISCVAS);
