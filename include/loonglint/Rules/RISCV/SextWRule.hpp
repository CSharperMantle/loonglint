...
#ifndef LOONGLINT_RULES_RISCV_SEXTWRULE_HPP
#define LOONGLINT_RULES_RISCV_SEXTWRULE_HPP
...
class SextWRule final : public Rule {
  public:
    explicit SextWRule(const RISCVSpec &RISCVAS);
