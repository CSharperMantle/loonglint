...
#ifndef LOONGLINT_RULES_RISCV_ZEXTHELIMRULE_HPP
#define LOONGLINT_RULES_RISCV_ZEXTHELIMRULE_HPP
...
class ZextHElimRule final : public Rule {
  public:
    explicit ZextHElimRule(const RISCVSpec &RISCVAS);
