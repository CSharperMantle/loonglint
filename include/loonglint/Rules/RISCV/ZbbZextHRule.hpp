...
#ifndef LOONGLINT_RULES_RISCV_ZBBZEXTHRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBBZEXTHRULE_HPP
...
class ZbbZextHRule final : public Rule {
  public:
    explicit ZbbZextHRule(const RISCVSpec &RISCVAS);
