...
#ifndef LOONGLINT_RULES_RISCV_SEXTWFORMRULE_HPP
#define LOONGLINT_RULES_RISCV_SEXTWFORMRULE_HPP
...
class SextWFormRule final : public Rule {
  public:
    explicit SextWFormRule(const RISCVSpec &RISCVAS);
