...
#ifndef LOONGLINT_RULES_RISCV_ZEXTHFORMRULE_HPP
#define LOONGLINT_RULES_RISCV_ZEXTHFORMRULE_HPP
...
class ZextHFormRule final : public Rule {
  public:
    explicit ZextHFormRule(const RISCVSpec &RISCVAS);
