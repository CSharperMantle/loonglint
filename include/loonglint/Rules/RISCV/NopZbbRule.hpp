...
#ifndef LOONGLINT_RULES_RISCV_NOPZBBRULE_HPP
#define LOONGLINT_RULES_RISCV_NOPZBBRULE_HPP
...
class NopZbbRule final : public Rule {
  public:
    explicit NopZbbRule(const RISCVSpec &RISCVAS);
