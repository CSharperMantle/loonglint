...
#ifndef LOONGLINT_RULES_RISCV_BEXTRULE_HPP
#define LOONGLINT_RULES_RISCV_BEXTRULE_HPP
...
class BextRule final : public Rule {
  public:
    explicit BextRule(const RISCVSpec &RISCVAS);
