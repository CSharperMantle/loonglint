...
#ifndef LOONGLINT_RULES_RISCV_ZEXTWFORMRULE_HPP
#define LOONGLINT_RULES_RISCV_ZEXTWFORMRULE_HPP
...
class ZextWFormRule final : public Rule {
  public:
    explicit ZextWFormRule(const RISCVSpec &RISCVAS);
