...
#ifndef LOONGLINT_RULES_RISCV_SEXTFORMRULE_HPP
#define LOONGLINT_RULES_RISCV_SEXTFORMRULE_HPP
...
class SextFormRule final : public Rule {
  public:
    explicit SextFormRule(const RISCVSpec &RISCVAS);
