...
#ifndef LOONGLINT_RULES_RISCV_ZBBNOPRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBBNOPRULE_HPP
...
class ZbbNopRule final : public Rule {
  public:
    explicit ZbbNopRule(const RISCVSpec &RISCVAS);
