...
#ifndef LOONGLINT_RULES_RISCV_SHIFTADDRULE_HPP
#define LOONGLINT_RULES_RISCV_SHIFTADDRULE_HPP
...
class ShiftAddRule final : public Rule {
  public:
    explicit ShiftAddRule(const RISCVSpec &RISCVAS);
