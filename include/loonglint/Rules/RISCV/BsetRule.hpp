...
#ifndef LOONGLINT_RULES_RISCV_BSETRULE_HPP
#define LOONGLINT_RULES_RISCV_BSETRULE_HPP
...
class BsetRule final : public Rule {
  public:
    explicit BsetRule(const RISCVSpec &RISCVAS);
