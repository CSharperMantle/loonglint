...
#ifndef LOONGLINT_RULES_RISCV_ZBBSEXTRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBBSEXTRULE_HPP
...
class ZbbSextRule final : public Rule {
  public:
    explicit ZbbSextRule(const RISCVSpec &RISCVAS);
