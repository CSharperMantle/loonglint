...
#ifndef LOONGLINT_RULES_RISCV_SEXTWELIMRULE_HPP
#define LOONGLINT_RULES_RISCV_SEXTWELIMRULE_HPP
...
class SextWElimRule final : public Rule {
  public:
    explicit SextWElimRule(const RISCVSpec &RISCVAS);
