...
#ifndef LOONGLINT_RULES_RISCV_BCLRRULE_HPP
#define LOONGLINT_RULES_RISCV_BCLRRULE_HPP
...
class BclrRule final : public Rule {
  public:
    explicit BclrRule(const RISCVSpec &RISCVAS);
