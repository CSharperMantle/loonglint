...
#ifndef LOONGLINT_RULES_RISCV_ZBBANDNRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBBANDNRULE_HPP
...
class ZbbAndnRule final : public Rule {
  public:
    explicit ZbbAndnRule(const RISCVSpec &RISCVAS);
