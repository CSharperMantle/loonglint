...
#ifndef LOONGLINT_RULES_RISCV_NOPZBARULE_HPP
#define LOONGLINT_RULES_RISCV_NOPZBARULE_HPP
...
class NopZbaRule final : public Rule {
  public:
    explicit NopZbaRule(const RISCVSpec &RISCVAS);
