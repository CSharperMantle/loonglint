...
#ifndef LOONGLINT_RULES_RISCV_NOTXORRULE_HPP
#define LOONGLINT_RULES_RISCV_NOTXORRULE_HPP
...
class NotXorRule final : public Rule {
  public:
    explicit NotXorRule(const RISCVSpec &RISCVAS);
