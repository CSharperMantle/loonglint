...
#ifndef LOONGLINT_RULES_RISCV_SEXTELIMRULE_HPP
#define LOONGLINT_RULES_RISCV_SEXTELIMRULE_HPP
...
class SextElimRule final : public Rule {
  public:
    explicit SextElimRule(const RISCVSpec &RISCVAS);
