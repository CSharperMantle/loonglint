...
#ifndef LOONGLINT_RULES_RISCV_ZBSBCLRRULE_HPP
#define LOONGLINT_RULES_RISCV_ZBSBCLRRULE_HPP
...
class ZbsBclrRule final : public Rule {
  public:
    explicit ZbsBclrRule(const RISCVSpec &RISCVAS);
