...
#ifndef LOONGLINT_RULES_LOONGARCH_MULHSEXTRULE_HPP
#define LOONGLINT_RULES_LOONGARCH_MULHSEXTRULE_HPP
...
class MulhSextRule final : public Rule {
  public:
    explicit MulhSextRule(const LoongArchSpec &LoongAS);
