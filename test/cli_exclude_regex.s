...
# SUBSTR: 1 finding(s)
# SUBSTR-NEXT: 1 integer/nop
# SUBSTR-NOT: branch-to-next

# RUN: not loonglint --input-format=raw --arch=loongarch64 -E '^control/' %t.bin | FileCheck %s --check-prefix=ANCHORED-CATEGORY
# ANCHORED-CATEGORY: 1 finding(s)
# ANCHORED-CATEGORY-NEXT: 1 integer/nop
# ANCHORED-CATEGORY-NOT: branch-to-next

# RUN: not loonglint --input-format=raw --arch=loongarch64 -E '^integer/nop$' %t.bin | FileCheck %s --check-prefix=ANCHORED-FULL
# ANCHORED-FULL: 1 finding(s)
# ANCHORED-FULL-NEXT: 1 control/branch-to-next
...
# ANCHOR-MISMATCH-NEXT: 1 integer/nop
# ANCHOR-MISMATCH-NEXT: 1 control/branch-to-next
